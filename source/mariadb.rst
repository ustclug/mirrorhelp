...
若安装时遇到错误 “Failed to connect to 2001:da8:d800:95::110: Network is unreachable”，将源地址中的 ``mirrors.nju.edu.cn`` 替换为 ``ipv4.mirrors.nju.edu.cn`` 以强制使用 IPv4：
...
2. 将 ``add-apt-repository`` 命令中的 "http://nl.mirror.babylon.network" 替换为 "https://mirrors.nju.edu.cn"
3. 执行命令
